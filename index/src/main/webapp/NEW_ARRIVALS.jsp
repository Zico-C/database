...
<body class="body" style="text-align: center;">
    ...
    <article style="height: 80%;width: 90%;margin: auto;clear: both;background-color: gray;">
        <div class="card-list">
            <a href="bag.jsp"><img src="img/bag.jpg" alt="bag" class="goods"></a>
            <h1>bag</h1>
            <p class="price">NT$999</p>
        </div>        
        <div class="card-list">
            <a href="Glasses.jsp"><img src="img/Glasses.jpg" alt="Glasses" class="goods"></a>
            <h1>Glasses</h1>
            <p class="price">NT$799</p>
        </div>
        <div class="card-list">
            <a href="Rings.jsp"><img src="img/Rings.jpg" alt="Rings" class="goods"></a>
            <h1>Rings</h1>
            <p class="price">NT$1999</p>
        </div>
        <div class="card-list">
            <a href="Shirt.jsp"><img src="img/shirt.jpg" alt="shirt" class="goods"></a>
            <h1>Shirt</h1>
            <p class="price">NT$1280</p>
        </div>        
        <div class="card-list">
            <a href="Shirt2.jsp"><img src="img/shirt2.jpg" alt="shirt2" class="goods"></a>
            <h1>Shirt</h1>
            <p class="price">NT$799</p>
        </div>
        <div class="card-list">
            <a href="Pants.jsp"><img src="img/Pants.jpg" alt="Pants" class="goods"></a>
            <h1>Pants</h1>
